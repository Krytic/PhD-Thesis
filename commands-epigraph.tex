...
\renewcommand{\epigraph}[3][0.5]{\begin{tcolorbox}[enhanced jigsaw,flush right,title={#3},halign=right,detach title,fonttitle=\scshape\color{black},after upper={\vspace{0.3em}\par\hfill--- \tcbtitle},colback=black!3!white,text width={#1\textwidth},boxrule=0mm,left=1mm,right=5mm,before skip=30pt,after skip=20pt,borderline east={1mm}{0pt}{black}]{\itshape #2}\end{tcolorbox}}

\newcommand{\mediaepigraph}[4][by]{\epigraph{#2}{\textit{#3}, #1\ #4}}

\newcommand{\twinEpigraphs}[4]{%
\begin{tcolorbox}[enhanced jigsaw,sidebyside,sidebyside align=bottom,segmentation style={draw=black,solid,line width=1mm},colback=black!3!white,text width=\textwidth,boxrule=0mm,left=1mm,right=0mm,before skip=10pt,after skip=20pt]%
{\begin{flushright}{\textit{#1}}\\\phantom{ }\par\hfill\scshape\color{black}--- #2\end{flushright}}%
\tcblower%
{\begin{flushleft}{\textit{#3}}\\\phantom{ }\par\scshape\color{black}--- #4\end{flushleft}}%
\end{tcolorbox}%
}
