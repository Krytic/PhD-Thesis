...
% \let\ovec\vec
% \renewcommand{\vec}[1]{{\bm{{\textnormal{\bfseries#1}}}}}
% \newcommand{\vectoruniti}{{\bm{\hat{\textnormal{\bfseries\i}}}}}
% \newcommand{\vectorunitj}{{\bm{\hat{\textnormal{\bfseries\j}}}}}
% \DeclareRobustCommand{\vu}[1]{{%s
%   \ifcsname vectorunit#1\endcsname
%      \csname vectorunit#1\endcsname
%    \else
%     \bm{\hat{\mathbf{#1}}}%
%    \fi
% }}
...
% \title{TITLELESS: The next generatIon: refining The standard popuLation synthEsis modeL to better prEdict Stellar population propertieS}
...
%         \pgfornament[color=black,scale=0.25]{89}%
...
%   {\llap{\colorbox{main-accent}{\parbox{2.5cm}{\strut\color{white}\hfill\thesection}}\hspace{20pt}}}
%   {0em}{#1}
%   [{\titleline*[l]{\hspace*{\dimexpr-2.5cm-20pt-2\fboxsep\relax}\color{main-accent}\titlerule[1.5pt]}}]
% \titleformat{\subsection}
%   {\addtolength{\titlewidth}{2pc}\normalfont\large}
%   {\llap{\colorbox{main-accent}{\parbox{2.5cm}{\strut\color{white}\hfill\thesubsection}}\hspace{20pt}}}
%   {0em}{#1}
%   [{\titleline*[l]{\hspace*{\dimexpr-2.5cm-20pt-2\fboxsep\relax}\color{main-accent}\titlerule[1.5pt]}}]
