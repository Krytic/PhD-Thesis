...
Secondly, we have assumed Newtonian mechanics. Formally, the derivations presented earlier (cf. \Cref{sec:binary_kinematics}) assumed general relativity for the existence of the gravitational wave equation,\footnote{Here, $\tensor{\bar{h}}{_{\mu\nu}}$ is the trace inverse of a weak perturbation to locally Minkowski spacetime with positive-definite trace, and $\Box$ is the d'Alembertian operator.}

\begin{equation}
    \Box \tensor{\bar{h}}{_{\mu\nu}} = -\frac12 \sqrt{32\pi G}\tensor{T}{_{\mu\nu}},\label{eq:GW_spacetime_equation}
\end{equation}

but the injected physics was Newtonian (see \citet{Richards:2021} for a derivation). Strictly speaking, relativistic corrections apply to these kinematic equations too. To acconut for this, one would need to apply corrections to the two-body equation of motion, termed the post-Newtonian approximation. The general equation becomes
