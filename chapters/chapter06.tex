...
\begin{figure}[!htbp]
    ...
    \caption[The effect of varying $\mathrm{d}e$ in \cref{eq:discrete_sum} on the coalescence time.]{The effect of varying $\mathrm{d}e$ in \cref{eq:discrete_sum} on the coalescence time. Although hard to see, the pink line does oscillate above and below the brown line. This binary was assumed to have $m_1=m_2=\SI{1.44}{\msun}$ and $a_0=\SI{1970.5}{\rsun}$ (the mean separation of a sample of binaries with $\alpha=\SI{100}{\km\per\s}, \beta=\SI{-170}{\km\per\s}$).}
    \label{fig:vary_de}
\end{figure}
