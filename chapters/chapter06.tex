...
Secondly, we have assumed Newtonian mechanics. Formally, the derivations presented earlier (c.f. \autoref{sec:binary_kinematics}) assumed general relativity for the existence of the gravitational wave equation,\footnote{Here, $\tensor{\bar{h}}{_{\mu\nu}}$ is the trace inverse of a weak perturbation to locally Minkowski spacetime with positive-definite trace, and $\Box$ is the d'Alembertian operator.}
