...
In this appendix, we present the results of our bespoke overcontact binaries as established in \Cref{sec:forward_evolution}. Shown are three parameter configurations, corresponding to the fiducial (normal period) grid in \Cref{fig:bespoke_binaries_normal}, and our $\pm\SI{0.1}{\dex}$ period grid \Cref{fig:bespoke_binaries_wider,fig:bespoke_binaries_shorter}. \todo{Rearrange these...}
