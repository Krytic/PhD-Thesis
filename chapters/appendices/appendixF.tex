...
where $x_1 = \frac{\log T-4.05}{0.75}$, $x_2=\frac{\log L-4.6}{2.1}$, and the coefficients $a_{ij}$ are given by
...
\begin{figure}[!htbp]
    ...
    \caption[The Chebyshev polynomial expansion of \Cref{eq:chebyshev}.]{The Chebyshev polynomial expansion of \Cref{eq:chebyshev}. A \SI{10}{\msun} model is overplotted in black for reference.}
