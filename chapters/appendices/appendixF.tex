...
\begin{figure}[!htbp]
    ...
    \caption[An illustration of the bi-stability jumps in the mass loss prescription.]{An illustration of the bi-stability jumps in the mass-loss prescription. This illustration was computed for a $\SI{21}{\msun}$ star. \textit{Left plot:} The lower bistability jump,  \textit{Right plot:} Shown in blue is the cool side of the bistability jump, where $R_3$ (\Cref{eq:R3}) is the interpolation, and shown in red is the hot side, where $R_2$ (\Cref{eq:R2}) is the interpolation.}
